                ...
                <div className='mt-16 md:mt-[120px]'>
                    <div className='w-full md:w-[544px] py-[50px] px-[56px] mx-auto' style={{
                        ...
                        <form onSubmit={handleSubmit} action=""  >
                            ...
                            <Link to="/auth/login" className='flex justify-center items-center '>  <button className='text-[#9096B2]  text-[17px] font-josefin font-normal mt-[28px]  '>Already have an Account? <span className='text-[#1D3178]'>sign in</span> </button></Link>
                        </form>
                    </div>
                </div>
            </Container>
